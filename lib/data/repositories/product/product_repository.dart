...
class ProductRepository extends GetxController {
  ...
  Future<List<ProductModel>> getProductsForCategory(
    ...
    try {
      final QuerySnapshot productCategoryQuery = limit == -1 ? await _db.collection('ProductCategory').where('categoryId', isEqualTo: categoryId).get() : await _db.collection('ProductCategory').where('categoryId', isEqualTo: categoryId).limit(limit).get();
  ...
  Future<List<ProductModel>> getFavouriteProducts({required List<String> productIds}) async {
    try {
